...
alter table `user_2`   add index fk_user_2_group_2 (`group_oid`), add constraint fk_user_2_group_2 foreign key (`group_oid`) references `group` (`oid_group`);


-- User_Group [User2Group_Group2User]
alter table `user_2`  add column  `group_oid_2`  integer;
alter table `user_2`   add index fk_user_2_group (`group_oid_2`), add constraint fk_user_2_group foreign key (`group_oid_2`) references `group` (`oid_group`);
