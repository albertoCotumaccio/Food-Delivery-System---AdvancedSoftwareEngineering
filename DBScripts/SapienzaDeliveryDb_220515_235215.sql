...
alter table `group`   add index fk_group_module (`module_oid`), add constraint fk_group_module foreign key (`module_oid`) references `module` (`oid_module`);
...
alter table `module`   add index fk_module_module (`module_oid`), add constraint fk_module_module foreign key (`module_oid`) references `module` (`oid_module`);
