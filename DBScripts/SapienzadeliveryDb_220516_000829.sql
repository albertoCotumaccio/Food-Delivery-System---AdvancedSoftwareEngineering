...
-- RiderUser_City [rel3]
alter table `rideruser`  add column  `city_name`  varchar(255);
alter table `rideruser`   add index fk_rideruser_city (`city_name`), add constraint fk_rideruser_city foreign key (`city_name`) references `city` (`name`);
...
alter table `restaurantuser`  add column  `city_name`  varchar(255);
alter table `restaurantuser`   add index fk_restaurantuser_city (`city_name`), add constraint fk_restaurantuser_city foreign key (`city_name`) references `city` (`name`);
