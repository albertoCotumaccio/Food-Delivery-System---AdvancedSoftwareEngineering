...
alter table `restaurantuser_cuisine_type`   add index fk_restaurantuser_cuisine_ty_2 (`restaurant_oid`), add constraint fk_restaurantuser_cuisine_ty_2 foreign key (`restaurant_oid`) references `restaurant` (`user_2_oid_user`);
alter table `restaurantuser_cuisine_type`   add index fk_restaurantuser_cuisine_type (`cuisine_type_name`), add constraint fk_restaurantuser_cuisine_type foreign key (`cuisine_type_name`) references `cuisine_type` (`name`);
